...
This privacy policy is applicable to the Kidney Guardian app (hereinafter referred to as “Application”) for mobile devices, which was developed by Manyu Lab LLC. (hereinafter referred to as “Service Provider”) as an Ad Supported service. This service is provided “AS IS”.

## What information does the Application obtain and how is it used?

The Application collects and processes information when you download and use it. This information may include:

* **Financial Information (Purchase History)**: If you purchase a subscription or in-app items within the Application, transaction information such as your purchase token, order ID, product ID, base plan ID, and purchase status is received from Google Play to verify and manage your subscription rights. The Service Provider does not directly collect or store payment card details or other raw financial information, which are handled directly by Google Play and payment processors.
* **Device or Other Identifiers**: Your mobile device's Advertising ID (`AD_ID`) and anonymous user identifiers for subscription status management are collected.
...
Data may be transmitted to third-party service providers to assist the Service Provider in improving the Application, delivering advertisements, and verifying subscription/in-app purchase status.
