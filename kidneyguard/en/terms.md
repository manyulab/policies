...
These terms and conditions apply to the Kidney Guardian app (hereby referred to as “Application”) for mobile devices that was created by Manyu Lab LLC. (hereby referred to as “Service Provider”) as an Ad Supported service.
...
* **Subscription Plans**:
  * **Weekly Plan (`weekly-plan`)**: 2,500 KRW per week (entry plan)
  * **Monthly Plan (`monthly-plan`)**: 6,900 KRW per month (standard plan)
  * **Yearly Plan (`yearly-plan-v2`)**: 49,000 KRW per year (discounted anchor plan with 7-day free trial)
