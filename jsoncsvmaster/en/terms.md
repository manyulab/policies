...
These terms and conditions apply to the JSON CSV Master app (hereby referred to as “Application”) for mobile devices that was created by Manyu Lab LLC. (hereby referred to as “Service Provider”) as an Ad Supported service.
...
* **Price**: 4,900 KRW (One-time payment for lifetime access)
* **Key Benefits**:
  * Permanent 100% removal of all advertisements (app open ads, rewarded conversion ads, etc.)
  * Unlimited permanent access to bidirectional JSON ↔ CSV conversion
  * Permanent unlock of premium features, including large dataset processing and nested JSON handling
...
These Terms and Conditions (and the Privacy Policy) are drafted in the Korean language. In the event of any conflict, discrepancy, or inconsistency between the Korean version and any translation thereof (including this English version), the Korean version shall prevail and govern. Any disputes arising from or relating to the use of the Application shall be governed by and construed in accordance with the laws of the Republic of Korea.
