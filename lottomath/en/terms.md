...
These terms and conditions apply to the Lotto Math app (hereby referred to as “Application”) for mobile devices that was created by Manyu Lab LLC. (hereby referred to as “Service Provider”) as an Ad Supported service.
...
* **Subscription Plans**:
  * **Weekly Plan (`weekly-plan`)**: 1,900 KRW per week (entry plan)
  * **Monthly Plan (`monthly-plan`)**: 4,900 KRW per month (standard plan)
  * **Yearly Plan (`yearly-plan`)**: 35,000 KRW per year (discounted anchor plan with 7-day free trial)
