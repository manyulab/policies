...
This privacy policy is applicable to the Lotto Math app (hereinafter referred to as “Application”) for mobile devices, which was developed by Manyu Lab LLC. (hereinafter referred to as “Service Provider”) as an Ad Supported service. This service is provided “AS IS”.

## What information does the Application obtain and how is it used?

The Application collects and processes information when you download and use it. This information may include:

* **Personal Information (Email Address)**: If you sign in via Google or utilize account synchronization features (e.g., data backup and restore), your email address may be collected and retained for account management and service provision.
* **Financial Information (Purchase History)**: If you purchase a subscription within the Application, transaction information such as your purchase token, order ID, product ID, base plan ID, and purchase status is received from Google Play to verify and manage your subscription rights. The Service Provider does not directly collect or store payment card details or other raw financial information, which are handled directly by Google Play and payment processors.
* **Device or Other Identifiers**: Your mobile device's Advertising ID (`AD_ID`), Firebase Instance ID, FCM push notification tokens, and anonymous user identifiers for service management are collected.
...
This Application does not directly collect or store precise real-time GPS location information from your mobile device. However, third-party advertising partners integrated into the Application (such as Google AdMob) may collect and process **coarse location information** derived from your IP address for ad serving, personalization, ad measurement, and fraud prevention purposes.
...
Data may be transmitted to third-party service providers to assist the Service Provider in improving the Application, delivering advertisements, analyzing app stability, sending push notifications, and verifying subscription/in-app purchase status.
...
* [RevenueCat](https://www.revenuecat.com/privacy/)
  - Processes purchase history and anonymous user identifiers to verify subscription access and handle billing support.
...
This Privacy Policy is drafted in the Korean language. In the event of any conflict, discrepancy, or inconsistency between the Korean version and any translation thereof (including this English version), the Korean version shall prevail and govern.

## Contact us

If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at manyulabllc@gmail.com.
